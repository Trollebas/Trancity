namespace Trancity
{
    ...
    public class ComputeTimeDialog : Form
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.Cancel_Button.Location = new System.Drawing.Point(12, 32);//(12, 0x20
        	this.Cancel_Button.Name = "Cancel_Button";
        	this.Cancel_Button.Size = new System.Drawing.Size(745, 23);//(0x2e9, 0x17)
        	...
        	// _progressBar
        	// 
        	this._progressBar.Location = new System.Drawing.Point(12, 12);//(12, 12)
        	this._progressBar.Name = "_progressBar";
        	this._progressBar.Size = new System.Drawing.Size(745, 14);//(0x2e9, 14)
        	...
        	this.ClientSize = new System.Drawing.Size(769, 67);//(0x301, 0x43
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            if (!this._refreshing)
            {
                ...
                else
                {
                    ...
                    string str = ". " + Localization.current_.speed + ": " + ((this._транспорт.скорость * 3.6)).ToString("0.00") + " " + Localization.current_.speed_km;
                    if (flag)
                    {
                        str = str + " (" + Localization.current_.shtangi_loosed + ")";
                        if (b1)
                        {
                        	_игрок.cameraPosition.xz_point = _транспорт.position;
                        	b1 = false;
                        }
                    }
                    if (this._text == null)
