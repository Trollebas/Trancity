...
//    using Microsoft.DirectX;
    ...
    public abstract class BaseStop : MeshObject, MeshObject.IFromFile, IMatrixObject, ITest
    {
        ...
        public void UpdatePosition(World мир)
        {
            if (this.road != null)
            {
                ...
                point_position.xz_point = this.road.НайтиКоординаты(this.distance, this.position.отклонение);
