	...
	public static class ObjectLoader
    {
        ...
        static ObjectLoader()
        {
            ...
            foreach (var directory in Directory.GetDirectories(path))
            {
                ...
                {
                	Logging.Write("ObjectLoader", "object.xml not found in directory " + directory1);
                    continue;
                }
                ...
                try
                {
                    ...
                    int index = (int)Xml.GetDouble(node["type"]);
                    try
		        	{
                ...
                {
                	Logging.Write("ObjectLoader", "Error in " + directory1 + "object.xml");
                    continue;
                }
            }
        }
        ...
        public static void FindModel(byte index, string name, ref ObjectModel model, ref string dir)
        {
        	...
        	{
        		Logging.Write("ObjectLoader", "Object " + name + " not found!");
//        		dir = string.Empty;
        	}
        }
    }
